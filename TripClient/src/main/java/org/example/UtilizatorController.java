...
//        coloanaMain2.setCellValueFactory(cellDataFeatures -> new SimpleStringProperty(serviceApp.loginUser(cellDataFeatures.toString()).get().getName()));
        ...
        //asta ii pentru prostia aia cu sterge selectionu;
//        tabelMain.getSelectionModel().selectedItemProperty().addListener(x-> {
//            var selectata = tabelMain.getSelectionModel().getSelectedItem();
//            if (selectata != null && false) {
//                Platform.runLater(() -> {
