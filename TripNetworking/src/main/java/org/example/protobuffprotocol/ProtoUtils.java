...
public class ProtoUtils {
    public static TripProtocol.Request createLoginRequest(Utilizator utilizator1) {
        ...
        TripProtocol.Request request = TripProtocol.Request.newBuilder().setType(TripProtocol.Request.RequestType.LOGIN).setUtilizator(utilizator).build();
        return request;
    }
